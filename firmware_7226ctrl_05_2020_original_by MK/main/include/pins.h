...
#define speedPin 22 // VR2 / voltage div 12/3 <-> black <-> blueyellowblue = 1kohm/380ohm div // DIN10
#define rpmPin 20 // VR1 / voltage div 12/3 <-> black <-> whitebluewhite = 1kohm/380ohm div // DIN12
